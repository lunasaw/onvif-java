...
public class DeviceDiscovery {
    public static final Logger logger = LoggerFactory.getLogger(DeviceDiscovery.class);
    ...
    public static Collection<InetAddress> getAddressList() {
        try {
    ...
    public static Collection<String> discoverWsDevices(List<String> ipList) {
        if (CollectionUtils.isEmpty(ipList)){
            return discoverWsDevices();
        }
        ArrayList<InetAddress> objects = Lists.newArrayList();
        ...
        for (String ip : ipList) {
            try {
                ...
                logger.error("找不到IP地址所属网卡，忽略！！discoverWsDevices::ipList = {} ", ip);
            }
        }

        return discoverWsDevices(objects);
    }

    public static Collection<String> discoverWsDevices() {
        Collection<InetAddress> addressList = getAddressList();
        return discoverWsDevices(addressList);
    }
     ...
     */
    public static Collection<String> discoverWsDevices(Collection<InetAddress> addressList) {
